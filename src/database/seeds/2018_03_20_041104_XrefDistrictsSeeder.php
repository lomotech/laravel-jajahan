...
class XrefDistrictsSeeder extends MigratableSeeder
{
    ...
    {
        $permission_seeds = [
            ['group' => 'xref_districts', 'name' => 'list xref_districts', 'description' => 'Web user able to list xref_districts data', 'guard_name' => 'web'],
            ['group' => 'xref_districts', 'name' => 'show xref_districts', 'description' => 'Web user able to show xref_districts data', 'guard_name' => 'web'],
            ['group' => 'xref_districts', 'name' => 'edit xref_districts', 'description' => 'Web user able to edit xref_districts data', 'guard_name' => 'web'],
            ['group' => 'xref_districts', 'name' => 'create xref_districts', 'description' => 'Web user able to create xref_districts data', 'guard_name' => 'web'],
            ['group' => 'xref_districts', 'name' => 'delete xref_districts', 'description' => 'Web user able to delete xref_districts data', 'guard_name' => 'web'],

            ['group' => 'xref_districts', 'name' => 'list xref_districts', 'guard_name' => 'api'],
            ['group' => 'xref_districts', 'name' => 'show xref_districts', 'guard_name' => 'api'],
            ['group' => 'xref_districts', 'name' => 'edit xref_districts', 'guard_name' => 'api'],
            ['group' => 'xref_districts', 'name' => 'create xref_districts', 'guard_name' => 'api'],
            ['group' => 'xref_districts', 'name' => 'delete xref_districts', 'guard_name' => 'api'],
        ];
        ...
        $states = XrefState::all()->pluck('id', 'ddsa_code');
        ...
        foreach ($data_seeds as $seed) {
            $seed['xref_state_id'] = $states[substr($seed['ddsa_code'], 0, 2)];
            XrefDistrict::create($seed);
        }
    }
